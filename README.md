...
| `guardrails` | [Codex](https://openai.com/codex/)            | [guardrails/README.md](guardrails/README.md)               |
...
→ [Full Codex setup, configuration, and troubleshooting](guardrails/README.md)
